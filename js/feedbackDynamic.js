const dynamicContent = document.getElementById('root');
...
newPage.innerHTML = `
    ...
    <div class="feedback">
    <p>Dear Customer,<br>
    Thank you for getting our services at our website. We would like to know how we performed. Please spare some moments to give us your valuable feedback as it will help us in improving our service.</p>
...
dynamicContent.appendChild(newPage);
